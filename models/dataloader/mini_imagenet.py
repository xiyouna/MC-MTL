...
class MiniImageNet(Dataset):
    ...
    def __init__(self, setname, args, return_path=False):
        ...
        TRAIN_PATH = osp.join(args.data_dir, 'split_images_mini/train')
        VAL_PATH = osp.join(args.data_dir, 'split_images_mini/val')
        TEST_PATH = osp.join(args.data_dir, 'split_images_mini/test')
        if setname == 'train':
            THE_PATH = TRAIN_PATH
        elif setname == 'test':
            THE_PATH = TEST_PATH
