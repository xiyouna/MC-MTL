...
class DatasetLoader(Dataset):
    ...
    def __init__(self, setname, args, train_aug=False):
        ...
        if args.dataset_dir == '/media/breeze/dataset/cub':
            IMAGE_PATH = os.path.join(args.dataset_dir, '')
            ...
            if args.dataset_dir == '/media/breeze/dataset/cifar_fs':
                if setname=='train':
                    THE_PATH = osp.join(args.dataset_dir, 'meta-train')
                    label_list = os.listdir(THE_PATH)
                elif setname=='test':
                    THE_PATH = osp.join(args.dataset_dir, 'meta-test')
                    label_list = os.listdir(THE_PATH)
                elif setname=='val':
                    THE_PATH = osp.join(args.dataset_dir, 'meta-val')
                    label_list = os.listdir(THE_PATH)
                else:
